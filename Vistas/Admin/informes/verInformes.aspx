            ...
            <div class="container">
                ...
                <main class="main-content">
                    ...
                    <div class="content-box">
                        <h3>Doctors with more shifts</h3>
                        <div style="margin-top: 40px;">
                            <asp:GridView ID="gvReporteMedicosMayoriaTurnos" runat="server" AutoGenerateColumns="False" Font-Bold="True" 
                                Font-Names="Bahnschrift" Width="100%" DataKeyNames="DNI_DOC" AllowPaging="False"
                                CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="gridview-doctores">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:TemplateField HeaderText="ID USER" SortExpression="ID_USER">
                                        <ItemTemplate>
                                            <asp:Label ID="lblID_USUARIO" runat="server" Text='<%# Bind("ID_USER") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="DNI" SortExpression="DNI_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDNI_MED" runat="server" Text='<%# Bind("DNI_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="SEX" SortExpression="GENDER_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSEXO_MED" runat="server" Text='<%# Bind("GENDER_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="NATIONALITY" SortExpression="NATIONALITY_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNACIONALIDAD_MED" runat="server" Text='<%# Bind("NATIONALITY_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="ADDRESS" SortExpression="ADDRESS_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDIRECCION_MED" runat="server" Text='<%# Bind("ADDRESS_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="BIRTHDATE" SortExpression="DATEBIRTH_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblFECHANAC_MED" runat="server" Text='<%# Bind("DATEBIRTH_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="STATE" SortExpression="NAME_STATE">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNOMBRE_PROV" runat="server" Text='<%# Bind("NAME_STATE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="CITY" SortExpression="NAME_CITY">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNOMBRE_LOC" runat="server" Text='<%# Bind("NAME_CITY") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="PHONE NUMBER" SortExpression="PHONE_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTELEFONO_MED" runat="server" Text='<%# Bind("PHONE_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="MAIL" SortExpression="EMAIL_DOC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCORREO_MED" runat="server" Text='<%# Bind("EMAIL_DOC") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                        ...
                        <h3 style="margin-top: 40px;">Speciality with most appointments</h3>
                        <div style="margin-top: 20px;">
                            <asp:GridView 
                                ID="gvEspecialidadTop" 
                                runat="server" 
                                AutoGenerateColumns="False" 
                                CssClass="gridview-doctores"
                                Width="100%"
                                CellPadding="4" 
                                ForeColor="#333333" 
                                GridLines="None">
